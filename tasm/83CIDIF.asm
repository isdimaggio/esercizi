...
TITLE differenza tra due valori a due cifre (con messaggi)
DATA SEGMENT
    NUM1 DB ?
    NUM2 DB ?
    SOM DB ?
...
Start:  MOV AX, DATA
        ...
        SUB AL, BL ; sommiamo il valore precedente caricato con quello del secondo addendo
                   ; già presente in AL
