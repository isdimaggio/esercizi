...
TITLE prodotto tra due valori a due cifre (con messaggi)
DATA SEGMENT
    NUM1 DB ?
    NUM2 DB ?
    SOM DB ?
...
Start:  MOV AX, DATA
        ...
        MOV BL, AL
        MOV AL, NUM1 ; carichiamo in BL il valore 1
        MUL BL ; sommiamo il valore precedente caricato con quello del secondo addendo
                   ; già presente in AL
