...
TITLE divisione tra due valori a due cifre (con messaggi)
DATA SEGMENT
    NUM1 DB ?
    NUM2 DB ?
    SOM DB ?
...
Start:  MOV AX, DATA
        ...
        ; ////// divisione dei due valori appena memorizzati //////
        MOV BL, AL ; carichiamo in BL il valore n2       
        MOV AL, NUM1
        DIV BL ; sommiamo il valore precedente caricato con quello del secondo addendo
                   ; già presente in AL
